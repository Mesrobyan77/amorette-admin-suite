...
const ACTION_META: Record<
  string,
  { icon: any; variant: "gold" | "sage" | "rose" | "muted" | "default"; label: string }
> = {
...
function AuditLogsPage() {
  ...
  }, [page, actionFilter, range.from, range.to]);
      ...
      <Card>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-3">
          <div className="lg:col-span-4 relative">
            ...
            <Input
              placeholder="Search target, IP, action…"
              className="pl-10"
              value={search}
              onChange={(e) => {
          ...
          <div className="lg:col-span-2">
            <Button variant="ghost" onClick={resetFilters} fullWidth>
              Clear
            </Button>
          </div>
        </div>
                      ...
                      >
                        <td className="px-5 py-3">
                          <span className="inline-flex items-center gap-2">
                            <span className="h-8 w-8 rounded-xl bg-muted flex items-center justify-center">
